...
// Import the generator as ES module
...
// Main execution
async function run() {
  console.log('🚀 Starting event page generator...');
  ...
  console.log(`🏙️ Processing ${venueData.size} cities...`);
...
`;
  ...
  console.log(`   Cities created: ${venueData.size}`);
