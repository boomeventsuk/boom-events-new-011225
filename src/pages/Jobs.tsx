    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-primary">Be part of the Midlands' favourite daytime disco.</p>
        </header>
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg p-8 border border-primary/20">
          ...
          <p className="text-muted-foreground mb-6">Drop us an email and tell us a bit about yourself.</p>
          <a 
